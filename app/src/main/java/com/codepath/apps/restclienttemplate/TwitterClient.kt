...
class TwitterClient(context: Context) : OAuthBaseClient(
    ...
    companion object {
        val REST_API_INSTANCE = TwitterApi.instance() // Change this - DONE

        const val REST_URL = "https://api.twitter.com/1.1" // Change this, base API URL - DONE
